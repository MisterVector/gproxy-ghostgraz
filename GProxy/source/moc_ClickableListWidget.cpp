...
void ClickableListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        ClickableListWidget *_t = static_cast<ClickableListWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData ClickableListWidget::staticMetaObjectExtraData = {
...
const QMetaObject ClickableListWidget::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_ClickableListWidget,
      qt_meta_data_ClickableListWidget, &staticMetaObjectExtraData }
};
