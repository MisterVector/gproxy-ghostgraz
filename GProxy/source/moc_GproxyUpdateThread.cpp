...
void GproxyUpdateThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData GproxyUpdateThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GproxyUpdateThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_GproxyUpdateThread,
      qt_meta_data_GproxyUpdateThread, &staticMetaObjectExtraData }
};
