...
void GhostGrazLogininformationDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        GhostGrazLogininformationDialog *_t = static_cast<GhostGrazLogininformationDialog *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData GhostGrazLogininformationDialog::staticMetaObjectExtraData = {
...
const QMetaObject GhostGrazLogininformationDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_GhostGrazLogininformationDialog,
      qt_meta_data_GhostGrazLogininformationDialog, &staticMetaObjectExtraData }
};
