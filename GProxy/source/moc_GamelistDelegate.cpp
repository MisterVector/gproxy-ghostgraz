...
void GamelistDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData GamelistDelegate::staticMetaObjectExtraData = {
...
const QMetaObject GamelistDelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata_GamelistDelegate,
      qt_meta_data_GamelistDelegate, &staticMetaObjectExtraData }
};
