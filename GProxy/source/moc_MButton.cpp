...
void MButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< MButton*(*)>(_a[1]))); break;
...
const QMetaObjectExtraData MButton::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_MButton,
      qt_meta_data_MButton, &staticMetaObjectExtraData }
};
